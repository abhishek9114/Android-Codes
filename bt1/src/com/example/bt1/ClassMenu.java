...
public class ClassMenu extends ListActivity {
	...
	String [] mi = {"Launcher","CMpurpose","ACTextDemo","FrameDemo","MessageSendApp","TransferDataIntent","TransferedDataIntent","MI8","MI9","MI10"
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		String [] zi = {"Launcher","CMpurpose","ACTextDemo","FrameDemo","MessageSendApp","TransferDataIntent","TransferedDataIntent","MI8","MI9","MI10"};
